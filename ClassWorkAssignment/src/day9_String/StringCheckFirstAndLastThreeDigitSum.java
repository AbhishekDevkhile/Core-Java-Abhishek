package day9_String;
/*Check string First and last three digit sum are equal or not
 * */
public class StringCheckFirstAndLastThreeDigitSum 
{
	...
	public static void main(String[] args) 
	{
		...
		for(int i=0;i<num.length();i++)
		{
			...
			else
			{
				...
				{
					sum2=sum1+Character.getNumericValue(num.charAt(i));
				}
				if(sum1==sum2)
				{
